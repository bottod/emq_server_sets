...
function set_temperature_graph(htmlid,theme,clientid)
{
...
function set_response_time_graph(htmlid,theme,clientid)
{
    echarts.dispose(document.getElementById(htmlid));
    var myChart = echarts.init(document.getElementById(htmlid),theme);
...
function set_voltage_graph(htmlid,theme,clientid)
{
    echarts.dispose(document.getElementById(htmlid));
    var myChart = echarts.init(document.getElementById(htmlid),theme);
...
function set_humidity_graph(htmlid,theme,clientid)
{
    echarts.dispose(document.getElementById(htmlid));
    var myChart = echarts.init(document.getElementById(htmlid),theme);
...
{
    set_response_time_graph("response_time_graph","dark",clientid);
    set_voltage_graph("voltage_graph","dark",clientid);
    set_temperature_graph("temperature_graph","dark",clientid);
    set_humidity_graph("humidity_graph","dark",clientid); 
